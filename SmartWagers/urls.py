...
urlpatterns = [
    ...
    path("administrator/approve-wager/", views.admin_approve_wager, name="admin-approve-wager"),
    path("administrator/reject-wager/", views.admin_reject_wager, name="admin-reject-wager"),
